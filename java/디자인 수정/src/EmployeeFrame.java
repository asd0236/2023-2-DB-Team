...
public class EmployeeFrame {
    ...
    private void initialize() {
        ...
        deleteButton.setBackground(buttoncolor);			// 버튼 색 지정
        deleteButton.setFont(new Font("맑은 고딕", Font.BOLD, 15));	// 버튼 글씨 설정
        ...
        editButton.setBackground(buttoncolor);			// 버튼 색 지정
        editButton.setFont(new Font("맑은 고딕", Font.BOLD, 15));	// 버튼 글씨 설정
        ...
        addButton.setBackground(buttoncolor);			// 버튼 색 지정
        addButton.setFont(new Font("맑은 고딕", Font.BOLD, 15));	// 버튼 글씨 설정
        ...
        btnNewButton_1.setBackground(buttoncolor);			// 버튼 색 지정
        btnNewButton_1.setFont(new Font("맑은 고딕", Font.BOLD, 15));	// 버튼 글씨 설정
